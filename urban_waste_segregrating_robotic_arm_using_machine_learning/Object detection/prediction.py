...
def detect_objects(image_np, sess, detection_graph):
    ...
    res = []
    #000print ([category_index.get(value) for index,value in enumerate(classes[0]) if scores[0,index] > 0.5])
    threshold=0.5
    #objects = []
    res.append([category_index.get(value) for index,value in enumerate(classes[0]) if scores[0,index] > 0.5])
    #print(scores)
    #print(objects)
    #res.append(objects)
